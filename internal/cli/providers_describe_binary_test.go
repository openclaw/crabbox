...
func TestProvidersDescribeBuiltBinaryContract(t *testing.T) {
	...
	const baselineSHA256 = "d2e17574c310d4e7755d5369d8344939d42c2f5e1a621296cf6d235a01e3a892"
	if got := hex.EncodeToString(digest[:]); got != baselineSHA256 || len(helpStderr) != 62035 {
		t.Fatalf("run --help changed: sha256=%s bytes=%d, want sha256=%s bytes=62035", got, len(helpStderr), baselineSHA256)
	}
}
