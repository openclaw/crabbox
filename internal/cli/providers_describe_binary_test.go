...
func TestProvidersDescribeBuiltBinaryContract(t *testing.T) {
	...
	const baselineSHA256 = "cdca000cc825bf1e30826325144acb0fce0aa2b9869c79c079f7945be8d0e250"
	if got := hex.EncodeToString(digest[:]); got != baselineSHA256 || len(helpStderr) != 60763 {
		t.Fatalf("run --help changed: sha256=%s bytes=%d, want sha256=%s bytes=60763", got, len(helpStderr), baselineSHA256)
	}
}
