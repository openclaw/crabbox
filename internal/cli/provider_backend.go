...
func providerHelpAll() string {
	return "provider: hetzner, aws, azure, gcp, proxmox, ssh, exe-dev, blacksmith-testbox, namespace-devbox, semaphore, daytona, islo, e2b, modal, sprites, railway, wandb, or cloudflare"
}
