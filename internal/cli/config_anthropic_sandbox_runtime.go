...
type AnthropicSRTConfig struct {
	CLIPath  string `config:"cliPath" env:"CRABBOX_ANTHROPIC_SANDBOX_RUNTIME_CLI" flag:"anthropic-sandbox-runtime-cli" sources:"user,repo,env,flag" help:"path to the srt CLI binary" default:"srt" fileIgnoreEmpty:"true"`
