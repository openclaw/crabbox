...
- Provider matrix/filter/recommend output and recent-provider history inspection: `internal/cli/providers.go`; provider history storage: `internal/cli/provider_history.go`
