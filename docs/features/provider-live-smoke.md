...
Current coverage: 77 providers; 4 with convention-named hermetic lifecycle tests, 57 with a live runner, 7 with tagged Go smoke tests, and 19 with none of those lifecycle surfaces.
