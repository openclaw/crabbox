...
Current coverage: 75 providers; 4 with convention-named hermetic lifecycle tests, 55 with a live runner, 3 with tagged Go smoke tests, and 19 with none of those lifecycle surfaces.
