...
Current coverage: 82 providers; 8 with convention-named hermetic lifecycle tests, 61 with a live runner, 8 with tagged Go smoke tests, and 19 with none of those lifecycle surfaces.
