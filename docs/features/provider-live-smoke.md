...
Current coverage: 80 providers; 4 with convention-named hermetic lifecycle tests, 60 with a live runner, 8 with tagged Go smoke tests, and 19 with none of those lifecycle surfaces.
...
| [run-cloud](../providers/run-cloud.md) | — | matrix | — |
