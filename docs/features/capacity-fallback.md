...
only for retryable Spot capacity or quota failures; terminal request errors,
such as an invalid block-device mapping, stop without an On-Demand retry. Azure
