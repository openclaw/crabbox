...
CRABBOX_LIVE=1 CRABBOX_LIVE_PROVIDERS=github-codespaces CRABBOX_LIVE_COORDINATOR=0 CRABBOX_GITHUB_CODESPACES_SMOKE_REPO=example-org/my-app CRABBOX_GITHUB_CODESPACES_SMOKE_REF=main GH_TOKEN=... scripts/live-smoke.sh
