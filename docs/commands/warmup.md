...
Machine0, Daytona, Incus, Parallels, and local-container leases, managed coordinator leases, and explicitly capable
...
A fixed lease ID is single-use. Direct AWS, Azure, DigitalOcean, Machine0, Daytona, Incus, Parallels, and local-container
