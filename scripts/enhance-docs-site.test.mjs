...
const fixture = `<!doctype html><html><head><title>Features - Crabbox Docs</title><style>.base{display:block}</style></head><body><main><header class="hero"><div class="hero-text"><p class="eyebrow">Features</p><h1>Features</h1></div><div class="hero-meta"><a class="edit" href="edit">Edit page</a></div></header><div class="doc-grid"><article class="doc"><h1 id="features">Features</h1><p>Capability docs.</p><h2 id="foundations"><a class="anchor" href="#foundations">#</a>Foundations</h2><ul><li><a href="configuration.html">Configuration</a>: precedence and schema.</li><li><a href="network.html">Network</a>: public and private reachability.</li></ul><h2 id="run"><a class="anchor" href="#run">#</a>Run</h2><ul><li><a href="artifacts.html">Artifacts</a>: screenshots and logs.</li></ul><nav class="page-nav"><a href="next.html">Next</a></nav></article><nav class="toc"><h2>On this page</h2></nav></div></main><script>const existing=true;
</script>
</body></html>`;

test("builds the feature explorer", () => {
  const out = enhanceFeaturesPage(fixture);
  assert.match(out, /From local edit to remote proof/);
...
test("is idempotent and ignores other pages", () => {
