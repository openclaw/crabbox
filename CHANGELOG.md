...
- Proxmox: retain bounded, redacted guest bootstrap diagnostics and native error causes after acquisition cleanup, preserving quiet success and CLI failure status. [Issue 1873](https://github.com/openclaw/crabbox/issues/1873). Thanks @coygeek.
