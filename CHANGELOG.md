...
- Retain qualification recovery for unresolved SSH ingress until an exact owned rule has a durable, verified revocation receipt; bounded empty inventory reads no longer retire cleanup ownership. [PR 1956](https://github.com/openclaw/crabbox/pull/1956).
