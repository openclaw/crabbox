...
- Reject decoded negative Freestyle VM sizing, including explicit negative sizing flags, before backend construction rather than silently omitting it; preserve zero/default and positive-value handling.
