...
- Recover exactly tagged, unattached Azure fixed-lease companions when the VM and original cleanup binding are missing, retaining the claim until deletion completes. [PR 2572](https://github.com/openclaw/crabbox/pull/2572).
