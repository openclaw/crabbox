...
- Consolidate KubeVirt settings and work-root selection without changing key-source rules, path expansion, saved-file semantics, or explicit release choices. Thanks @steipete.
