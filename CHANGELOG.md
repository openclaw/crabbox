...
- Apple Machine: honor cancellation through ownership waits and native controls, include claim-lock waiting in cleanup budgets, and preserve the original failure when acquisition rollback also fails.
