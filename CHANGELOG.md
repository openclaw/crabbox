...
- Move AWS and Hetzner provisioning-failure interpretation behind provider adapters while retaining coordinator-owned cleanup, cancellation, and retry decisions.
