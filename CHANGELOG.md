...
- Allow retained AWS image qualification when an AMI includes instance-store mappings beside its single EBS root, while preserving exact root identity, volume bounds, and borrowed-resource cleanup checks.
