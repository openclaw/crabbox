...
- Fixed XCP-ng XenAPI integer encoding, template validation, failure-recoverable VM ownership, copied-disk and local-key cleanup, generated Windows answer media, pre-boot answer attachment, and bounded ISO E2E cleanup.
