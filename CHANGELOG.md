...
- Restore Lume guest bootstrap with named shared directories, keeping private per-acquisition staging and support for older single-share image layouts; existing golden images need refreshed hooks.
