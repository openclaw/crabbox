...
- Preserve Lume's last successfully published claim when acquisition metadata updates fail, retaining recovery state instead of falling back to unguarded rollback.
