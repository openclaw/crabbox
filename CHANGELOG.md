...
- Record local-container creation references, runtime image IDs, and reported repository digests in run evidence and retained inspection for Docker and Podman, preserving saved observations after cleanup. [Issue 1601](https://github.com/openclaw/crabbox/issues/1601).
