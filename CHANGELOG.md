...
- Cloud Run Sandbox: preserve direct command exits and primary typed failures through activity cleanup, teardown and reporting, with terminal timing and recovery-session reporting based on the final outcome.
