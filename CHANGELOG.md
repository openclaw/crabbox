...
- Added direct and brokered AWS cache volumes for public Linux SSH leases, with exact-AZ encrypted gp3 members, opaque identity tags, durable pre-launch reservations, exact NVMe serial mounting, ABI replacement, detach-before-reuse, purge-on-release, and exact-record garbage collection.
