...
- Honor cancellation while Lume release and automatic cleanup wait for a lease claim, freeing capacity for other operations while preserving the VM, claim and SSH key before deletion.
