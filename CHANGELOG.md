...
- Orgo: share failure finalization so cleanup and timing errors preserve primary command/API exit codes and no longer report success after failed cleanup; retain workspace ownership and no-copy behavior.
