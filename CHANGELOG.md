...
- Consolidate Sealos DevBox file, environment, and flag settings while preserving local versus guest path handling, explicit release choices, and saved-file omission. Thanks @steipete.
