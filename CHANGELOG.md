...
- Validate sparse-checkout and skip-worktree sync scope before SSH lease work, explain how to materialize or exclude missing tracked files, and still rebuild the final manifest after acquisition. [Issue 1567](https://github.com/openclaw/crabbox/issues/1567). Thanks @coygeek.
