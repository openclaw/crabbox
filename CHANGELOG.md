...
- Preserve Azure Dynamic Sessions command timeout milliseconds without nanosecond overflow and reject unrepresentable wire values before run authentication, retaining TTL/default precedence. Thanks @steipete.
