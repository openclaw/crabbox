...
- Preserved provider ownership fingerprints, exact metadata, and empty attestation fields during heartbeat updates so fixed AWS and other provider leases remain replayable after use.
