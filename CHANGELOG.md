...
- Fence fixed-lease replay after interrupted deletion across legacy state formats, and reject inconsistent Parallels cleanup identities and invalid terminal receipts.
