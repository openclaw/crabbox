...
- Pinned managed Linux Code Server and Tailscale installs to checksum-verified archives in both CLI and coordinator bootstrap paths, eliminating privileged installer-script execution and preserving `package` as a pinned compatibility alias. Thanks @TurboTheTurtle.
