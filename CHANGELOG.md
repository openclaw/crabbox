...
- Crownest: accept but omit framework-owned run bookkeeping without enabling command env forwarding, preserve primary outcomes and typed cleanup errors in final timing, and retain recovery claims when Workspace Run cancellation fails.
