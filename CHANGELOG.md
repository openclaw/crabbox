...
- Reject non-finite Vercel Sandbox vCPU values during configuration validation instead of failing later while encoding a bridge request; preserve zero/service-default and supported fractional values.
