...
- Keep Upstash Box and SmolVM status age and hardware metadata tied to native observations, preserve recorded local lease policy across Upstash reuse, and omit unknown policy instead of inventing current defaults or expiry.
