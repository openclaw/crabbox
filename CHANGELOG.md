...
- **More reliable Windows runs and private Mac setup.** Fixed native Windows SSH command-input handling and kept managed macOS bootstrap passwords out of shell traces and process arguments.
